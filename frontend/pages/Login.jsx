  ...
  <div className="lg:w-[50vw] w-[88vw]  h-[60vh]  rounded-lg shadow-2xl overflow-hidden">
    <div className="flex flex-col lg:flex-row h-full ">
      ...
      <div className="lg:w-3/5 bg-gradient-to-r from-green-500 to-[#409DB9] bg-[length:200%_200%] animate-gradient-x  p-8 lg:p-12 h-full">
        <h2 className="text-[4vh] lg:text-[4.5vh]  mb-6 text-gray-800">
          Login Form
        </h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 lg:text-[1.8vh] text-[2.5vh]  rounded-lg bg-indigo-500 text-white font-semibold hover:bg-indigo-600 transition-colors duration-300"
          >
            Login
          </button>
        </form>
