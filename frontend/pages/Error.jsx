...
const Error = () => {
  ...
  return (
    <div className="error-container h-[80vh]  bg-black text-white p-6 text-center ">
      <h1 className="error-title text-red-500  text-[8vh] mb-[8vh]">Error Occurred</h1>
      <NavLink to="/graytm" className="nav-link text-white text-[5vh] mr-[5vw] no-underline">Home</NavLink>
